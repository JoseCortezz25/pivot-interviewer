...
export const Hero = () => {
  return (
    <section className="container mx-auto px-4 py-20 relative">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-gradient-to-br from-purple-100 via-orange-100 to-purple-50 blur-3xl opacity-30 dark:hidden" />
      <div className="max-w-4xl mx-auto text-center relative">
        ...
        <div className="flex items-center justify-center gap-4">
          <Link href="/interviewer">
            <Button size="full" className="bg-black text-white hover:bg-gray-800 dark:bg-white dark:text-black">
              Get Started
